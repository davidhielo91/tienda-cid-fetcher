...
export default function InstaladoresWindowsPage() {
  useEffect(() => {
    document.title = "Instaladores Windows - Tienda CID Fetcher";
  }, []);
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground mt-2">
          Descarga los instaladores oficiales de Windows directamente desde Microsoft ({filtered.length} disponibile{filtered.length !== 1 ? "s" : ""}).
        </p>
      </div>
