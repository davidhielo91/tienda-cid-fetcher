...
const versionIcons: Record<string, typeof FileText> = {
  "Office 365": FileText,
  "Office 2013": FileText,
  "Office 2016": FileText,
  "Office 2019": FileText,
  "Office 2021": FileText,
  "Office 2024": FileText,
};

export default function InstaladoresOfficePage() {
  useEffect(() => {
    document.title = "Descargar Office 2024 ISO - Office 2021, 2019, 2016, 2013";
    const meta = document.querySelector('meta[name="description"]');
    if (meta) meta.setAttribute("content", "Descarga ISO oficial de Microsoft Office 2024 Professional Plus, Office 2021, 2019, 2016 y 2013. Enlaces directos al CDN de Microsoft en español e inglés.");
  }, []);
          ...
          <nav className="lg:sticky lg:top-24 space-y-3">
            ...
            <div className="space-y-0.5">
              ...
              {currentInstallers.map((v) => {
                const Icon = versionIcons[v.version] || FileText;
